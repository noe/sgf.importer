...
package sgfimporter.tools.adapter;

import static sgfimporter.go.GoColor.BLACK;
import static sgfimporter.go.GoColor.EMPTY;
import static sgfimporter.go.GoColor.WHITE;
...
import sgfimporter.game.BoardUpdater;
import sgfimporter.game.ConstNode;
import sgfimporter.game.GameTree;
import sgfimporter.game.TimeSettings;
import sgfimporter.gamefile.GameReader;
import sgfimporter.go.Board;
import sgfimporter.go.BoardUtil;
import sgfimporter.go.ConstPointList;
import sgfimporter.go.GoColor;
import sgfimporter.go.GoPoint;
import sgfimporter.go.InvalidKomiException;
import sgfimporter.go.Komi;
import sgfimporter.go.Move;
import sgfimporter.go.PointList;
import sgfimporter.gtp.GtpCallback;
import sgfimporter.gtp.GtpClient;
import sgfimporter.gtp.GtpClientBase;
import sgfimporter.gtp.GtpCommand;
import sgfimporter.gtp.GtpEngine;
import sgfimporter.gtp.GtpError;
import sgfimporter.gtp.GtpResponseFormatError;
import sgfimporter.gtp.GtpSynchronizer;
import sgfimporter.gtp.GtpUtil;
